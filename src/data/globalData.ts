...
export const TESTIMONIALS = [
   {
      ...
      role: "QA Manager",
      profileImg:
         "https://storage.googleapis.com/download/storage/v1/b/prd-shared-services.firebasestorage.app/o/h2m-assets%2F7eae4590bc0266386e4669d6ab2c02378368f147.png%3Fscale-down-to=1024&width=960&height=1200?generation=1771443084195017&alt=media",
   },
   {
      text: "It feels like having a QA analyst on every call — without the overhead. Our agents improve faster than ever.",
      name: "Tom E.",
      role: "Operations Lead",
      profileImg:
         "https://storage.googleapis.com/download/storage/v1/b/prd-shared-services.firebasestorage.app/o/h2m-assets%2Ffc5fad9828e0f1c903f5cf7a8ed46df3a31af4a2.png%3Fscale-down-to=512&width=1200&height=1200?generation=1771443084218890&alt=media",
   },
   {
      text: "CallClarity is the backbone of our compliance workflow — from SOP checks to audit-ready reports, it handles everything.",
      name: "Peter M.",
      role: "Compliance Officer",
      profileImg:
         "https://storage.googleapis.com/download/storage/v1/b/prd-shared-services.firebasestorage.app/o/h2m-assets%2F471728f422b1a8bb68c9adf3b6f56ada1180415b.png%3Fscale-down-to=1024&width=960&height=1200?generation=1771443084204612&alt=media",
   },
   {
      text: "We reduced agent coaching time by 60%. CallClarity flags exactly what needs attention so supervisors can act fast.",
      name: "John H.",
      role: "Support Supervisor",
      profileImg:
         "https://storage.googleapis.com/download/storage/v1/b/prd-shared-services.firebasestorage.app/o/h2m-assets%2Fbeb8e395dea5751c0d84296ceb9d4b16075fdf2c.png%3Fscale-down-to=512&width=1200&height=1200?generation=1771443084218624&alt=media",
   },
];
...
export const LOGO_BLUR_IMG =
   'https://storage.googleapis.com/download/storage/v1/b/prd-shared-services.firebasestorage.app/o/h2m-assets%2F9f676721f71c6a8a84b5dcea0885eb38746ba3a4.png%3Fwidth=360&height=312?generation=1771443083880491&alt=media';
...
export const HERO_PROFILE_IMGS = [
   ...
   "https://storage.googleapis.com/download/storage/v1/b/prd-shared-services.firebasestorage.app/o/h2m-assets%2F0fae8b17a8e69d4c8b65fbda15800b62ea43664d.png%3Fscale-down-to=1024&width=1108&height=1470?generation=1771443083887266&alt=media",
...
export const HERO_ICON_ATTACH =
   "https://storage.googleapis.com/download/storage/v1/b/prd-shared-services.firebasestorage.app/o/h2m-assets%2F2957d11ac8201e0e43e330eb80026a6ba334977e.svg?generation=1771443083927263&alt=media";
export const HERO_ICON_WEB =
   "https://storage.googleapis.com/download/storage/v1/b/prd-shared-services.firebasestorage.app/o/h2m-assets%2F2843b6e664c1aa09e1dea5f7e788ca0e482010c0.svg?generation=1771443084033620&alt=media";
export const HERO_ICON_MIC =
   "https://storage.googleapis.com/download/storage/v1/b/prd-shared-services.firebasestorage.app/o/h2m-assets%2F9ff1911cfdbefdad60b2086bb75bec05db213e8b.svg?generation=1771443084086373&alt=media";
...
export const HERO_SHARE_ICON =
   "https://storage.googleapis.com/download/storage/v1/b/prd-shared-services.firebasestorage.app/o/h2m-assets%2F844a9f4856ca07ba8b68200f254cc831815e1664.svg?generation=1771443084045919&alt=media";
export const HERO_COPY_ICON =
   "https://storage.googleapis.com/download/storage/v1/b/prd-shared-services.firebasestorage.app/o/h2m-assets%2Ff687b7b1ef0d2de980e78acd69fcecdf76fd3539.svg?generation=1771443084045475&alt=media";
...
export const HERO_FIND_ICON_SVG =
   "data:image/svg+xml,<svg xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" viewBox=\"0 0 15.563 13.94\" overflow=\"visible\"><path d=\"M 4.952 0 C 2.217 0 0 2.217 0 4.952 C 0 7.686 2.217 9.903 4.952 9.903 L 5.708 9.903 C 5.641 9.434 5.641 8.957 5.708 8.488 L 4.952 8.488 C 2.998 8.488 1.415 6.905 1.415 4.952 C 1.415 2.998 2.998 1.415 4.952 1.415 L 10.61 1.415 C 11.673 1.415 12.679 1.892 13.35 2.714 C 14.022 3.537 14.289 4.618 14.076 5.659 C 14.493 6.068 14.835 6.546 15.085 7.074 C 15.813 5.539 15.704 3.739 14.796 2.304 C 13.888 0.869 12.308 0 10.61 0 Z M 10.61 7.074 C 9.438 7.074 8.488 8.024 8.488 9.196 C 8.488 10.368 9.438 11.318 10.61 11.318 C 11.782 11.318 12.732 10.368 12.732 9.196 C 12.732 8.024 11.782 7.074 10.61 7.074 Z M 7.074 9.196 C 7.074 7.683 8.036 6.338 9.468 5.849 C 10.9 5.361 12.484 5.837 13.409 7.034 C 14.334 8.231 14.395 9.884 13.561 11.146 L 15.355 12.94 L 14.354 13.94 L 12.561 12.147 C 11.474 12.865 10.082 12.928 8.935 12.311 C 7.788 11.694 7.073 10.498 7.074 9.196 Z\" fill=\"rgb(255, 255, 255)\" opacity=\"0.88\"></path></svg>";
...
export const FAQ_ITEMS = [
   {
      ...
      answer: 'CallClarity offers 100% call coverage with automated QA, real-time SOP adherence checks, and compliance risk detection — not just spot sampling.',
   },
   {
      question: 'What types of calls can it analyze?',
      answer: 'CallClarity works with inbound and outbound calls, support chats, and recorded audio across any industry with compliance requirements.',
   },
   {
      question: 'How is my data protected?',
      answer: 'All call data is encrypted at rest and in transit. We follow strict privacy standards and are compliant with GDPR and SOC 2 requirements.',
   },
   {
      question: 'Is CallClarity available for remote teams?',
      answer: 'Yes — CallClarity is fully cloud-based and accessible from any browser, supporting distributed QA and compliance teams across time zones.',
   },
   {
      question: 'Can I use it for team-wide coaching?',
      answer: 'Absolutely. CallClarity surfaces per-agent performance trends, coaching flags, and SOP gaps that supervisors can act on directly.',
   },
   {
      question: 'Does it work with my existing phone system?',
      answer: 'CallClarity integrates with major telephony and CCaaS platforms. Our team can assist with custom integrations for enterprise setups.',
   },
];

export const FAQ_SECTION_TITLE = 'Frequently asked questions answered';
